...
/* Connecting, selecting database */
 $link=connect_db($db_host, $db_username, $db_password, $db_name);
    echo"<H1>Albums dont la maison d'édition est $maison </h1>";

    echo"<H1>Et dont la collection  est $collection </h1>";
    $query = "SELECT album.album_id,
				...
				WHERE maison_edition.maison LIKE '%$maison%' 
				AND maison_edition.collection LIKE '%$collection%' 
				AND serie.serie_id= album.serie_id 
 ...
 print"<TR>
<TD><FONT COLOR=BLUE><a href=\"result_maison.php?choix=$choix&maison=$maison&collection=$collection&order='serie.nom, album.place'\">série</a></FONT></TD>
<TD><FONT COLOR=BLUE>place</FONT></TD>
<TD><FONT COLOR=BLUE><a href=\"result_maison.php?choix=$choix&maison=$maison&collection=$collection&order=album.nom\">album</a></FONT></TD>
<TD><FONT COLOR=BLUE><a href=\"result_maison.php?choix=$choix&maison=$maison&collection=$collection&order=maison_edition.maison\">Edition</a></FONT></TD>
<TD><FONT COLOR=BLUE><a href=\"result_maison.php?choix=$choix&maison=$maison&collection=$collection&order=maison_edition.collection\">collection</a></FONT></TD>
<TD><FONT COLOR=BLUE><a href=\"result_maison.php?choix=$choix&maison=$maison&collection=$collection&order=dessinateur.nom\">dessinateur</a></FONT></TD>
<TD><FONT COLOR=BLUE><a href=\"result_maison.php?choix=$choix&maison=$maison&collection=$collection&order=scenariste.nom\">scénariste</a></FONT> </TD>
...
{
print("<H2>Le champ maison doit être non vide!!!</H2>");
}
?>
