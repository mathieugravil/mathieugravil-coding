...
if($dessinateur)
{
echo"<H1>Albums dont le nom du dessinateur contient $dessinateur: </h1>";
/* Connecting, selecting database */
 $link=connect_db($db_host, $db_username, $db_password, $db_name);

$query = "SELECT album.album_id, 
			serie.nom,album.place,album.url,
			album.nom,maison_edition.maison,
			...
			WHERE serie.serie_id=album.serie_id 
			...
			AND  dessinateur.nom LIKE '$dessinateur%' 
...
print"<TR>
<TD><FONT COLOR=BLUE><a href=\"result_dessinateur.php?dessinateur=$dessinateur&order='serie.nom, album.place'\">série</a></FONT></TD>
<TD><FONT COLOR=BLUE>place</FONT></TD>
<TD><FONT COLOR=BLUE><a href=\"result_dessinateur.php?dessinateur=$dessinateur&order=album.nom\">album</a></FONT></TD>
<TD><FONT COLOR=BLUE><a href=\"result_dessinateur.php?dessinateur=$dessinateur&order=maison_edition.maison\">Edition</a></FONT></TD>
<TD><FONT COLOR=BLUE><a href=\"result_dessinateur.php?dessinateur=$dessinateur&order=maison_edition.collection\">collection</a></FONT></TD>
<TD><FONT COLOR=BLUE><a href=\"result_dessinateur.php?dessinateur=$dessinateur&order=dessinateur.nom\">dessinateur</a></FONT></TD>
<TD><FONT COLOR=BLUE><a href=\"result_dessinateur.php?dessinateur=$dessinateur&order=scenariste.nom\">scénariste</a></FONT> </TD>
