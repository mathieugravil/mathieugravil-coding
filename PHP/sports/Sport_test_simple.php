...
FROM sports.seances, sports.sport_type
WHERE seances.sport_id=sport_type.sport_id
AND sports.seances.date <= date_format('$end','%Y/%m/%d')
AND sports.seances.date >= date_format('$start','%Y/%m/%d')
GROUP BY sport_name
;";
$result = mysql_query($query) or die("La requ�te  $query a echou�e");
...
GROUP BY date;
;";
     $result2 = mysql_query($query2) or die("La requ�te $query2 a echou�e");
...
from sports.seances
WHERE sports.seances.date <= date_format('$end','%Y/%m/%d')
AND sports.seances.date >= date_format('$start','%Y/%m/%d')
;";
 $result3 = mysql_query($query3) or die("La requ�te $query3 a echou�e");    
...
WHERE sports.seances.date <= date_format('$end','%Y/%m/%d')
AND sports.seances.date >= date_format('$start','%Y/%m/%d');";
$result4 = mysql_query($query4) or die("La requ�te $query4 a echou�e");
...
$result5 = mysql_query($query5) or die("La requ�te $query5 a echou�e");
...
order by date
;";
$result6 = mysql_query($query6) or die("La requ�te $query6 a echou�e");
...
ORDER BY  date;
";
$result70 = mysql_query($query70) or die("La requ�te $query70 a echou�e");
...
$result71 = mysql_query($query71) or die("La requ�te $query71 a echou�e");
...
$DataSet5->SetYAxisFormat("time"); 
 ...
 $Test5->Render("/sportzone_sport.png");
*/
//=============End result 5========================
...
// Draw the line graph  
 ...
 // Finish the graph     
 $Test61->setFontProperties("../lib/Fonts/tahoma.ttf",8);     
 $Test61->drawLegend(0,0,$DataSet6->GetDataDescription(),255,255,255);     
 $Test61->setFontProperties("../lib/Fonts/tahoma.ttf",10);     
 $Test61->drawTitle(60,22,"Evolution des Calories d�pens�es",50,50,50,585);     
 $Test61->Render("/calories.png");     
...
*/
	...
	$result71 = mysql_query($query71) or die("La requ�te 71d $query71 a echou�e");
...
$result71 = mysql_query($query71) or die("La requ�te 71c a echou�e");
while ($row71 = mysql_fetch_array($result71, MYSQL_NUM))
         {
         	/*
...
$chart_cal_h_sp->setDataSet($dataSet_cal_h_sp);
	...
	$chart_cal_h_sp->render("/cal_h_sp.png");
*/
 /* Free resultset */
...
echo "</td>
<td>";
printf("<img src=\"/cal_h_sp.png\"></img>");
echo "
</tr>
</table>
<table>
...
echo" </td>
<td>";
printf("<img src=\"/sportzone_sport.png\"></img>");
echo "</td>
</tr>
<tr>
<td>
...
<tr>
<td>";
printf("<img src=\"/example20.png\"></img>");
echo "
</td>
</tr><tr><td>";
printf("<img src=\"/FC.png\"></img>");
echo"
</td></tr>
<tr>
<td>";
printf("<img src=\"/calories.png\"></img>");
echo"
</td></tr>
<tr>
<td>";
printf("<img src=\"/vitesse.png\"></img>");
echo"
</td></tr>
<tr>
<td>";
printf("<img src=\"/distance.png\"></img>");
