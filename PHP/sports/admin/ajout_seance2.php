...
<TR><TD> Date:</TD><TD> 
<?php
printf("<Input name=\"date\" type=\"date\" value=%s  onclick=\"new calendar(this);\" size=\"8\"></TD>",date("Y-m-d"));
?>
</TR>
...
<TR><TD> Above:</TD><TD> <Input name="above" type="text" size="8" value="00:00:00" onChange=calcul_duration_total(this.form)></TD>
</TR>
<TR><TD> Below:</TD><TD> <Input name="below" type="text" size="8" value="00:00:00"  onChange=calcul_duration_total(this.form)></TD>
</TR>
<TR><TD> In zone:</TD><TD> <Input name="in_zone" type="text" size="8" value="00:00:00" onChange=calcul_duration_total(this.form)></TD>
</TR>
...
<TR><TD> Distance:</TD><TD><Input name="dist" type="int" size="5" onChange=calcul_vmoy(this.form)></TD>
</TR>
